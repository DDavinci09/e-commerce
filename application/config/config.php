...
$config['sess_driver'] = 'files';
$config['sess_cookie_name'] = 'ci_session';
$config['sess_samesite'] = 'Lax'; // Sesuaikan ini jika diperlukan
$config['sess_expiration'] = 7200; // 2 jam
$config['sess_save_path'] =sys_get_temp_dir(); // jika menggunakan 'files';
$config['sess_match_ip'] = FALSE; // Sesuaikan jika perlu
$config['sess_time_to_update'] = 300; // 5 menit
$config['sess_regenerate_destroy'] = FALSE; // Sesuaikan jika perlu
