    ...
    <div class="container">
        <div class="card">
            <div class="row">
                <div class="col-lg-5">
                    <div class="card">
                        <img class="img m-2" src="https://via.placeholder.com/300x200" alt="">
                    </div>
                </div>
                <div class="col-lg-7">
                    <h2>Keterangan </h2>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Explicabo nobis quas quis nostrum
                        labore. Quod pariatur reiciendis et praesentium similique maiores laboriosam ipsam, quidem illum
                        possimus numquam, earum nemo at! Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                        Eveniet voluptatum vero nulla expedita ullam commodi omnis temporibus molestiae autem
                        voluptatibus, exercitationem illo voluptates minus quo ut. Quos animi dicta doloribus?</p>
                </div>
            </div>
            <div class="row">
                <div class="col">
