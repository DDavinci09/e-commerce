...
<div class="product_image_area">
    <div class="container">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control"
                                                        placeholder="Jumlah Pesanan" id="jml_pesanan"
                                                        name="jml_pesanan">
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card single-prd-item">
                    <?php if ($produk['diskon_produk'] > 0 ) { ?>
                    <span class="discount-badge position-absolute">
                        <?= $produk['diskon_produk'] ?>%
                    </span>
                    <?php } ?>
                    <?php if (!$produk['image']) { ?>
                    <img class="img-fluid rounded mx-auto" src="<?= base_url('./assets/upload/produk/no_image.jpg') ?>"
                        href="<?= base_url('./assets/upload/produk/no_image.jpg') ?>"
                        style="hight: 500px; width: 500px;">
                    <?php } else { ?>
                    <img class="img-fluid rounded  mx-auto"
