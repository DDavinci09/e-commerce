    ...
    <section class="section-margin mt-0">
        <div class="owl-carousel owl-theme hero-carousel">
            <div class="hero-carousel__slide">
                <img src="../assets/home/img/home/hero-slide1.png" alt="" class="img-fluid">
            ...
            <div class="hero-carousel__slide">
                <img src="../assets/home/img/home/hero-slide2.png" alt="" class="img-fluid">
                <a href="#" class="hero-carousel__slideOverlay">
                    <h3>Wireless Headphone</h3>
                    <p>Accessories Item</p>
                </a>
            ...
            <div class="hero-carousel__slide">
                <img src="../assets/home/img/home/hero-slide3.png" alt="" class="img-fluid">
                <a href="#" class="hero-carousel__slideOverlay">
                    <h3>Wireless Headphone</h3>
                    <p>Accessories Item</p>
                </a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="card text-center card-product">
                        <div class="card-product__img">
                            ...
                            <?php } else { ?>
                            <img class="card-img" src="<?= base_url('./assets/upload/produk/') . $tr['image']; ?>"
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-product__title"><a href="single-product.html"><?= $tr['nama_produk']; ?></a>
                            </h4>
            ...
            <div class="owl-carousel owl-theme" id="bestSellerCarousel">
                ...
                <div class="card text-center card-product">
                    <div class="card-product__img">
                        ...
                        <?php } else { ?>
                        <img class="card-img" src="<?= base_url('./assets/upload/produk/') . $tb['image']; ?>"
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-product__title"><a href="single-product.html"><?= $tb['nama_produk']; ?></a>
                        </h4>
                        <p class="card-product__price">
                            <?php if ($tb['diskon_produk'] > 0 ) { ?>
                            <span class="text-danger">
                ...
                <div class="card text-center card-product">
                    <div class="card-product__img">
                        ...
                        <img class="card-img" src="<?= base_url('./assets/upload/produk/no_image.jpg') ?>"
                            ...
                            style="height: 200px; width: 200px;">
                        <?php } else { ?>
                        <img class="card-img" src="<?= base_url('./assets/upload/produk/') . $dk['image']; ?>"
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-product__title"><a href="single-product.html"><?= $dk['nama_produk']; ?></a>
                        </h4>
                        <p class="card-product__price">
                            <?php if ($dk['diskon_produk'] > 0 ) { ?>
                            <span class="text-danger">
